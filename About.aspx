    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="jumbotron" style="border:2px solid blue; border-radius:60px;">
                <p style="color:white; font-size:large; margin-left10px;margin-top:10px;">TaskTracker is a powerful task tracking tool that helps you stay organized and on top of your to-do list. With TaskTrack, you can easily register your tasks and set reminders for important deadlines, so you never miss a deadline again.</p>
            ...
            <ul>
                ...
                <li style="color:white; font-size:large">Track the progress of each task and </li>
                <li style="color:white; font-size:large">Organisation Lead can track their employees daily perfromance</li>
            </ul>
