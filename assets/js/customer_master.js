...
var app = {
    ...
    execute: function () {
        ...
        table = $('#table').DataTable({
            "scrollX"     : true,
            "ajax"        : "assets/php/Data/customer_master",
            "columnDefs"  : [
                {
            ...
            "initComplete": function (settings, json) {
                ...
                $(settings.nTableWrapper).find('.row').first().find('#table_filter').append('<a href="javascript:void(0)" id="show_multiple_filter" class="btn btn-dark btn-sm m-l-10"><i class="fa fa-filter"></i> Multiple Filter</a><a href="' + fileName + '" class="btn btn-dark btn-sm m-l-10"><i class="ion-plus"></i> Add Customers</a>');
