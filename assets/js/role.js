...
var app = {
    ...
    execute: function () {
        ...
        table = $('#table').DataTable({
            "ajax"        : "assets/php/Data/role",
            "columnDefs"  : [
                {
                    "render" : function (data, type, row) {
                        return '<a href="javascript:void(0)" class="label label-primary" data-placement="top" data-toggle="tooltip" title="View">View</a>' +
                            '<a href="add_role_master.html" class="label label-warning m-l-5" data-placement="top" data-toggle="tooltip" title="Edit">Edit</a>';
                    },
                    "targets": 3
                } ],
            "columns"     : [
            ...
            "initComplete": function (settings, json) {
                ...
                $(settings.nTableWrapper).find('.row').first().find('#table_filter').append('<a href="'+fileName+'" class="btn btn-dark btn-sm m-l-10"><i class="ion-plus"></i> Add Role</a>');
                var all_col = this;
