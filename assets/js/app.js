...
var App = {
    ...
    panel_elements: function () {
        "use strict";
        $('.panel .heading-elements .refresh_element').on('click', function (e) {
            e.preventDefault();
        ...
        $('.panel .heading-elements .close_element').on('click', function (e) {
            e.preventDefault();
//            var $panelClose = $(this).closest(".panel").parent();
        ...
        $('.panel .heading-elements .collapse_element').on('click', function (e) {
            e.preventDefault();
