...
var app = {
    ...
    execute: function () {
        ...
        table = $('#table').DataTable({
            "ajax"        : "assets/php/Data/location_master",
            "columnDefs"  : [
                {
            ...
            "initComplete": function (settings, json) {
                ...
                $(settings.nTableWrapper).find('.row').first().find('#table_filter').append('<a href="'+fileName+'" class="btn btn-dark btn-sm m-l-10"><i class="ion-plus"></i> Add Locations</a>');
                var all_col = this;
